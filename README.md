...
```javascript
zaxpb = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-zaxpb@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var zaxpb = require( 'path/to/vendor/umd/blas-ext-base-zaxpb/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-zaxpb@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-zaxpb.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-zaxpb

[test-image]: https://github.com/stdlib-js/blas-ext-base-zaxpb/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-zaxpb/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-zaxpb/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-zaxpb?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-zaxpb.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-zaxpb/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-zaxpb/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-zaxpb/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-zaxpb/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-zaxpb/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-zaxpb/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-zaxpb/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-zaxpb/blob/main/branches.md
